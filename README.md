...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Native%20iOS-Swift%206%20%7C%20FSRS--6-F05138?style=for-the-badge&logo=swift&logoColor=white&labelColor=0a0e12" alt="Swift 6 FSRS-6" />
...
========================================================================================
  ...
  [UNIFIED iOS]         Swift 6 Ready + SwiftUI (iOS 17+) + FSRS-6 + 100% FL380 Offline
  [AI RAG ENGINE]       Hybrid BGE-M3 Dense + BM25 Lexical + Cosine Threshold >= 0.28
  ...
  [DATA RESIDENCY]      Saudi PDPL Compliant · 100% Local In-Kingdom Compute / me-central2
========================================================================================
```
...
The Fly GACA ecosystem spans 5 purpose-built, synchronized repositories:
...
| **[awesome-saudi-open-source](https://github.com/iflygaca/awesome-saudi-open-source)** | Curated community index of high-impact open-source projects crafted by Saudi developers. | Creative Commons CC-BY 4.0, Markdown Documentation |
...
- **Privacy by Default:** Zero learner profiling or biometric collection. Complete compliance with the Saudi Personal Data Protection Law (PDPL).
